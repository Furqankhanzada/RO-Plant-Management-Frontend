    ...
    renderRoute() {
        return (
            <div className="fl w-100 pl4 pr4">
                <Switch>
                    <Route exact path="/customers" token={this.state.token} component={DashboardPage}/>
                    <Route exact path="/customers/create" token={this.state.token} component={CreateCustomer} />
